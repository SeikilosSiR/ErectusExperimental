...
const std::unordered_map<std::uint32_t, std::string> JUNK_COMPONENT_NAMES = {
		{ 0x00017DE8, "Чёрный титан" },
		{ 0x00017DE9, "Ультрацит" },
		{ 0x0001FA8C, "Кислота" },
		{ 0x0001FA91, "Алюминий" },
		{ 0x0001FA94, "Защитные волокна" },
		{ 0x0001FA96, "Антисептик" },
		{ 0x0001FA97, "Асбест" },
		{ 0x0001FA98, "Кости" },
		{ 0x0001FA9A, "Керамика" },
		{ 0x0001FA9B, "Схемы" },
		...
		{ 0x0001FA9D, "Пробка" },
		{ 0x0001FA9F, "Кристал" },
		{ 0x0001FAA0, "Оптическое волокно" },
		{ 0x0001FAA1, "Стекловолокно" },
		{ 0x0001FAA4, "Стекло" },
		{ 0x0001FAA5, "Клей" },
		{ 0x0001FAA6, "Золото" },
		{ 0x0001FAAD, "Свинец" },
		{ 0x0001FAAE, "Кожа" },
		{ 0x0001FAB0, "Шестеренки" },
		{ 0x0001FAB3, "Ядерный материал" },
		{ 0x0001FAB4, "Масло" },
		{ 0x0001FAB7, "Пластик" },
		{ 0x0001FAB9, "Резина" },
		{ 0x0001FABB, "Серебро" },
		...
		{ 0x0003D294, "Болт" },
		{ 0x0005A0C4, "Бетон" },
		{ 0x0005A0C7, "Удобрение" },
		{ 0x001223C7, "Ткань" },
		{ 0x002B9178, "Кобальтовый флюс" },
		{ 0x002B917A, "Флуоресцентный флюс" },
		{ 0x002B917C, "Фиолетовый флюс" },
		{ 0x002B917E, "Алый флюс" },
		{ 0x002B9180, "Урановый флюс" },
		{ 0x0031C09A, "Уголь" },
		{ 0x0054E4FA, "Сталь убежища 94" },
};
const std::unordered_map<std::uint32_t, std::string> FLORA_COMPONENT_NAMES = {
		{ 0x002DDD45, "Алый флюс" },
		{ 0x002DDD46, "Кобальтовый флюс" },
		{ 0x002DDD49, "Урановый флюс" },
		{ 0x002DDD4B, "Флуоресцентный флюс" },
		{ 0x002DDD4D, "Фиолетовый флюс" },
		{ 0x00017F81, "Жила черного титана" },
		{ 0x00019D29, "Алюминивая жила" },
		{ 0x00019E36, "Золотая жила" },
		{ 0x00019E51, "Медная жила" },
		{ 0x00065304, "Железная жила" },
		{ 0x00065324, "Свинцовая жила" },
		{ 0x00065328, "Серебрянная жила" },
		{ 0x00065338, "Урановая жила" },
		{ 0x00139013, "Ультрацитовая жила" },
		{ 0x00058AA8, "Уголь" },
		{ 0x0016FAD8, "Неочищенный уголь" },
		{ 0x0056AAD2, "Облученная руда" },
		{ 0x0000BAEF, "Дикая Ежевика" },
		{ 0x000F742E, "Морковь" },
		{ 0x000330F8, "Кукуруза" },
		{ 0x000EF24D, "Тыква" },
		{ 0x000FAFEB, "Арбуз" },
		{ 0x00033102, "Мутофрукт" },
		{ 0x000E0043, "Бритвозлак" },
		{ 0x0009DCC4, "Тошка" },
		{ 0x000183C6, "Куча мусора" },
		{ 0x000731A3, "Бревно" },
		{ 0x00106D99, "Гравий" },
		{ 0x001BF732, "Отработанное масло" },
		{ 0x001BF72D, "Отработанная кислота" },
		{ 0x00015C61, "Необработанный кристалл" },
		{ 0x001BF730, "Необработанное удобрение" },
		{ 0x0010D90E, "Клюква" },
		{ 0x001FABC2, "Заражонная клюква" },
		{ 0x000D981D, "Смоляника" },
		{ 0x0012C48E, "Ягодная хлопушка" },
		{ 0x001F24B6, "Цветок арбуза" },
		{ 0x001C400D, "Цветы тошки" },
		{ 0x001C4013, "Цветы моркови" },
		{ 0x001C4011, "Цветок тыквы" },
		{ 0x001C0FC2, "Мозгогриб" },
		{ 0x001C0FC3, "Светящийся гриб" },
		{ 0x001C25EE, "Кровавый лист" },
		{ 0x001BE2AB, "Илофасоль" },
		{ 0x001C3FDC, "Цветок саженца" },
		{ 0x003C51E0, "Токсичный цветок саженца" },
		{ 0x0009F24B, "Чертополох" },
		{ 0x00525644, "Цветок Рододендрона" },
		{ 0x00064AF0, "Огненный гриб" },
		{ 0x003C51DF, "Хвостолом" },
		{ 0x00384D8C, "Ягоды ночного ползуна" },
		{ 0x000E34E9, "Мутированный цветок" },
		{ 0x00111346, "Сухая трава" },
		{ 0x00110A12, "Астра" },
		{ 0x00111345, "Гриб" },
		{ 0x00113106, "Лихоцвет" },
		{ 0x003FFADB, "Цветок калейдопора" },
		{ 0x0011C0C2, "Пепельная роза" },
		{ 0x00412186, "Нутрянной гриб" },
		{ 0x00088C3C, "Тыква" },
		{ 0x004EE5D2, "Корень женьшеня" },
		{ 0x003B90A2, "Переваренная жижа" },
		{ 0x00081FDB, "Цветок душителя" },
		{ 0x00050DC9, "Бутон с лозы душителя" },
		{ 0x003D7496, "Болотное Растение" },
		{ 0x003D202D, "Казил" },
		{ 0x00142950, "Гриб сверхленивца" },
		{ 0x000933EA, "Светящаяся Смола" },
		{ 0x0008E922, "Яйцо молерота" },
};
